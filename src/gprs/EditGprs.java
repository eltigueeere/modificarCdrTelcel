...
public class EditGprs {
	...
	public String[][] gprsEdit() throws FileNotFoundException, IOException {
			...
			for(int i=0; i<parametros.length; i++) {
				...
				for(int j=0; j<divicion.divicionCdr(); j++) {
					...
					consumoCdrModificado[i][j] = 
							consumoCdr[consumoContador-1].substring(0,27) + parametrosSplit[1] + parametrosSplit[0] +
							consumoCdr[consumoContador-1].substring(54,155) + fecha1[j] + consumoCdr[consumoContador-1].substring(169,434);
