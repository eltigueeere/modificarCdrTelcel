...
public class EditOroam {
	...
	public String[][] oroamEdit() throws FileNotFoundException, IOException {
			...
			for(int i=0; i<parametros.length; i++) {
				...
				for(int j=0; j<divicion.divicionCdr(); j++) {
					...
					consumoCdrModificado[i][j] = 
							consumoCdr[consumoContador-1].substring(0,90) + fecha1[j] + consumoCdr[consumoContador-1].substring(104,207) +
							parametrosSplit[1] + parametrosSplit[0] + consumoCdr[consumoContador-1].substring(234,404);
