...
public class EditMms {
	...
	public String[][] mmsEdit() throws FileNotFoundException, IOException {
			...
			for(int i=0; i<parametros.length; i++) {
				...
				for(int j=0; j<divicion.divicionCdr(); j++) {
					...
					consumoCdrModificado[i][j] = 
							consumoCdr[consumoContador-1].substring(0,11) + parametrosSplit[0] + 
							consumoCdr[consumoContador-1].substring(23,71) + fecha1[j] + fecha1[j] + fecha1[j] +
							consumoCdr[consumoContador-1].substring(113,118) + parametrosSplit[1] + fecha1[j] +
							consumoCdr[consumoContador-1].substring(147,177);
